...
public class UI_ObjectParams : MonoBehaviour
{
    ...
    private static readonly Dictionary<ShapeParams, UIParamInfo> shapeParamUIMap = new Dictionary<ShapeParams, UIParamInfo>
    {
        ...
        { ShapeParams.X_INIT_POSITION, new UIParamInfo("UI_XInitPosition", ShapeParamsNorm.X_INIT_POSITION_MEAN, ShapeParamsNorm.X_INIT_POSITION_STD, ShapeParamsNorm.X_INIT_POSITION_INCLUDE, 0, 1, 0, 0.5f, 0) },
        { ShapeParams.Y_INIT_POSITION, new UIParamInfo("UI_YInitPosition", ShapeParamsNorm.Y_INIT_POSITION_MEAN, ShapeParamsNorm.Y_INIT_POSITION_STD, ShapeParamsNorm.Y_INIT_POSITION_INCLUDE, 0, 1, 0, 0.5f, 0) },
        { ShapeParams.Z_INIT_POSITION, new UIParamInfo("UI_ZInitPosition", ShapeParamsNorm.Z_INIT_POSITION_MEAN, ShapeParamsNorm.Z_INIT_POSITION_STD, ShapeParamsNorm.Z_INIT_POSITION_INCLUDE, 0, 1, 0, 0.5f, 0) },
    ...
    public void Init(SceneController sceneController, ShapeParamLabels shapeID)
    {
        ...
        // Set position
        Vector3 pos = new Vector3(sceneController.uiScreenBoundary.xMax, sceneController.uiScreenBoundary.yMax, 0);
